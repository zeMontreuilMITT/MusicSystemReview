...
namespace HotelSystemReview.Controllers
{
    ...
    {
        private readonly HotelSystemReviewContext _context;

        public ClientsController(HotelSystemReviewContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Client != null ? 
                          ...
                          Problem("Entity set 'HotelSystemReviewContext.Client'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HotelSystemReviewContext.Client'  is null.");
            }
            var client = await _context.Client.FindAsync(id);
            if (client != null)
            {
